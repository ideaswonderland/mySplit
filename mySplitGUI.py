...
class ADM(QWidget):
    ...
    def hesapla(self):
        Fatura(self.spinAy.value(),self.spinYıl.value()).ADM()
        self.showDialog()
...
class Secİnternet(QWidget):
    def __init__(self):
        ...
        btnMem.clicked.connect(lambda: self.memSender())
...
class MEMTelefon(QWidget):
    ...
    def hesapla(self):
        Fatura(self.spinAy.value(),self.spinYıl.value()).MEMTelefon()
        self.showDialog()
...
class SecTelefon(QWidget):
    def __init__(self):
        ...
        btnTem = QPushButton(text="Temel Eğitim")
        btnTem.setFixedSize(230, 60)
        btnTem.clicked.connect(lambda: self.telefonSender())
